 ...
 */
class getSessionsVoteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SessionsVoteRepository' shared autowired service.
     *
     * @return \App\Repository\SessionsVoteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SessionsVoteRepository.php';

        return $container->privates['App\\Repository\\SessionsVoteRepository'] = new \App\Repository\SessionsVoteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
