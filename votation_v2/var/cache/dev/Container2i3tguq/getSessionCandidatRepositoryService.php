 ...
 */
class getSessionCandidatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SessionCandidatRepository' shared autowired service.
     *
     * @return \App\Repository\SessionCandidatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SessionCandidatRepository.php';

        return $container->privates['App\\Repository\\SessionCandidatRepository'] = new \App\Repository\SessionCandidatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
